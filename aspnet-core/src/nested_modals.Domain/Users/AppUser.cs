...
namespace nested_modals.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update nested_modalsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update nested_modalsEfCoreEntityExtensionMappings to extend the IdentityUser entity
